...
#define TFT_RST 26	// uncomment if you have ILI9340
#define TFT_DC 12	// Command/Data for LCD
#define TFT_CS 13	// Chip Select for LCD

#define SD_CS 33		// Chip Select for SD card
