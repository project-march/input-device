...
// Adafruit_ILI9341 tft = Adafruit_ILI9341(LCD_CS, DC, MOSI, SCK, RST, MISO);
ILI9341_t3 tft = ILI9341_t3(LCD_CS, DC);
...
void loop() {
  ...
  bmpDraw("sofa2.bmp", 0, 0);
  delay(5000);
  bmpDraw("stairs2.bmp", 0, 0);
  delay(5000);
  bmpDraw("slope2.bmp", 0, 0);
  delay(5000);
}
